...
echo_and_run cd "/home/itron/refactored-pancake/catkin_ws/src/multimaster/fkie_node_manager_daemon"
...
echo_and_run /usr/bin/env \
    ...
    "/home/itron/refactored-pancake/catkin_ws/src/multimaster/fkie_node_manager_daemon/setup.py" \
     \
    build --build-base "/home/itron/refactored-pancake/catkin_ws/build/multimaster/fkie_node_manager_daemon" \
    install \
    --root="${DESTDIR-/}" \
