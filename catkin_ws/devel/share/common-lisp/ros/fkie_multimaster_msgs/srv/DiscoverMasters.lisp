...
(cl:defmethod cl:initialize-instance :after ((m <DiscoverMasters-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DiscoverMasters-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fkie_multimaster_msgs-srv:<DiscoverMasters-request> is deprecated: use fkie_multimaster_msgs-srv:DiscoverMasters-request instead.")))
...
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<DiscoverMasters-request>)))
  ...
  "31a962d97ea3e3c12d428ff4786f124b")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'DiscoverMasters-request)))
  "Returns md5sum for a message object of type 'DiscoverMasters-request"
  "31a962d97ea3e3c12d428ff4786f124b")
...
(cl:defclass <DiscoverMasters-response> (roslisp-msg-protocol:ros-message)
  ((masters
    :reader masters
    :initarg :masters
    :type (cl:vector fkie_multimaster_msgs-msg:ROSMaster)
   :initform (cl:make-array 0 :element-type 'fkie_multimaster_msgs-msg:ROSMaster :initial-element (cl:make-instance 'fkie_multimaster_msgs-msg:ROSMaster))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <DiscoverMasters-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'DiscoverMasters-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fkie_multimaster_msgs-srv:<DiscoverMasters-response> is deprecated: use fkie_multimaster_msgs-srv:DiscoverMasters-response instead.")))

(cl:ensure-generic-function 'masters-val :lambda-list '(m))
(cl:defmethod masters-val ((m <DiscoverMasters-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-srv:masters-val is deprecated.  Use fkie_multimaster_msgs-srv:masters instead.")
  (masters m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <DiscoverMasters-response>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'masters)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'fkie_multimaster_msgs-msg:ROSMaster))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'DiscoverMasters)))
  ...
  "fkie_multimaster_msgs/DiscoverMasters")