...
(cl:defmethod cl:initialize-instance :after ((m <Task-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Task-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fkie_multimaster_msgs-srv:<Task-request> is deprecated: use fkie_multimaster_msgs-srv:Task-request instead.")))

(cl:ensure-generic-function 'node-val :lambda-list '(m))
(cl:defmethod node-val ((m <Task-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-srv:node-val is deprecated.  Use fkie_multimaster_msgs-srv:node instead.")
  (node m))
...
(cl:defmethod cl:initialize-instance :after ((m <Task-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Task-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fkie_multimaster_msgs-srv:<Task-response> is deprecated: use fkie_multimaster_msgs-srv:Task-response instead.")))
