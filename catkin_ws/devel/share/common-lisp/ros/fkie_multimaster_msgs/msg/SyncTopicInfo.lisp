...
(cl:defmethod cl:initialize-instance :after ((m <SyncTopicInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SyncTopicInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fkie_multimaster_msgs-msg:<SyncTopicInfo> is deprecated: use fkie_multimaster_msgs-msg:SyncTopicInfo instead.")))

(cl:ensure-generic-function 'topic-val :lambda-list '(m))
(cl:defmethod topic-val ((m <SyncTopicInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:topic-val is deprecated.  Use fkie_multimaster_msgs-msg:topic instead.")
  (topic m))
