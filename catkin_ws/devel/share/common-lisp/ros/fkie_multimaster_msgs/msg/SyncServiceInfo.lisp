...
(cl:defmethod cl:initialize-instance :after ((m <SyncServiceInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SyncServiceInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fkie_multimaster_msgs-msg:<SyncServiceInfo> is deprecated: use fkie_multimaster_msgs-msg:SyncServiceInfo instead.")))

(cl:ensure-generic-function 'service-val :lambda-list '(m))
(cl:defmethod service-val ((m <SyncServiceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:service-val is deprecated.  Use fkie_multimaster_msgs-msg:service instead.")
  (service m))

(cl:ensure-generic-function 'serviceuri-val :lambda-list '(m))
(cl:defmethod serviceuri-val ((m <SyncServiceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:serviceuri-val is deprecated.  Use fkie_multimaster_msgs-msg:serviceuri instead.")
  (serviceuri m))

(cl:ensure-generic-function 'node-val :lambda-list '(m))
(cl:defmethod node-val ((m <SyncServiceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:node-val is deprecated.  Use fkie_multimaster_msgs-msg:node instead.")
  (node m))

(cl:ensure-generic-function 'nodeuri-val :lambda-list '(m))
(cl:defmethod nodeuri-val ((m <SyncServiceInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:nodeuri-val is deprecated.  Use fkie_multimaster_msgs-msg:nodeuri instead.")
  (nodeuri m))
