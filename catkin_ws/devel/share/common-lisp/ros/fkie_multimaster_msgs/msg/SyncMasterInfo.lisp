...
(cl:defclass <SyncMasterInfo> (roslisp-msg-protocol:ros-message)
  ((masteruri
   ...
   (publisher
    :reader publisher
    :initarg :publisher
    :type (cl:vector fkie_multimaster_msgs-msg:SyncTopicInfo)
   :initform (cl:make-array 0 :element-type 'fkie_multimaster_msgs-msg:SyncTopicInfo :initial-element (cl:make-instance 'fkie_multimaster_msgs-msg:SyncTopicInfo)))
   (subscriber
    :reader subscriber
    :initarg :subscriber
    :type (cl:vector fkie_multimaster_msgs-msg:SyncTopicInfo)
   ...
   (services
    :reader services
    :initarg :services
    :type (cl:vector fkie_multimaster_msgs-msg:SyncServiceInfo)
   :initform (cl:make-array 0 :element-type 'fkie_multimaster_msgs-msg:SyncServiceInfo :initial-element (cl:make-instance 'fkie_multimaster_msgs-msg:SyncServiceInfo))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <SyncMasterInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SyncMasterInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name fkie_multimaster_msgs-msg:<SyncMasterInfo> is deprecated: use fkie_multimaster_msgs-msg:SyncMasterInfo instead.")))

(cl:ensure-generic-function 'masteruri-val :lambda-list '(m))
(cl:defmethod masteruri-val ((m <SyncMasterInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:masteruri-val is deprecated.  Use fkie_multimaster_msgs-msg:masteruri instead.")
  (masteruri m))

(cl:ensure-generic-function 'nodes-val :lambda-list '(m))
(cl:defmethod nodes-val ((m <SyncMasterInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:nodes-val is deprecated.  Use fkie_multimaster_msgs-msg:nodes instead.")
  (nodes m))

(cl:ensure-generic-function 'publisher-val :lambda-list '(m))
(cl:defmethod publisher-val ((m <SyncMasterInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:publisher-val is deprecated.  Use fkie_multimaster_msgs-msg:publisher instead.")
  (publisher m))

(cl:ensure-generic-function 'subscriber-val :lambda-list '(m))
(cl:defmethod subscriber-val ((m <SyncMasterInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:subscriber-val is deprecated.  Use fkie_multimaster_msgs-msg:subscriber instead.")
  (subscriber m))

(cl:ensure-generic-function 'services-val :lambda-list '(m))
(cl:defmethod services-val ((m <SyncMasterInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader fkie_multimaster_msgs-msg:services-val is deprecated.  Use fkie_multimaster_msgs-msg:services instead.")
  (services m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <SyncMasterInfo>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'publisher)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'fkie_multimaster_msgs-msg:SyncTopicInfo))
  ...
  (cl:let ((vals (cl:slot-value msg 'services)))
    (cl:dotimes (i __ros_arr_len)
    (cl:setf (cl:aref vals i) (cl:make-instance 'fkie_multimaster_msgs-msg:SyncServiceInfo))
  (roslisp-msg-protocol:deserialize (cl:aref vals i) istream))))
  msg
)
